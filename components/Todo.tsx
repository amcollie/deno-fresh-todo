...
export function Todo({ todo, onTodoRemove, onTodoEdit }: ITodoProps) {
    ...
    return (
        <div className="mb-5 h-12 rounded-md bg-gray-50 flex justify-between items-center content-between">
            {isEdit ? (
            ...
            <div className="flex">
                <button 
                    className="px-3 flex h-full justify-center items-center"
                    onClick={() => setIsEdit((prevState: boolean) => !prevState)}
                >
